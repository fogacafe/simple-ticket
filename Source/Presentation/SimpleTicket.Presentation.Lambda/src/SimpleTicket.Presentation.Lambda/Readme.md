...
Execute unit tests
```
    cd "SimpleTicket.Presentation.Lambda/test/SimpleTicket.Presentation.Lambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "SimpleTicket.Presentation.Lambda/src/SimpleTicket.Presentation.Lambda"
